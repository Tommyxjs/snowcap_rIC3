                ...
                for c_id in self.reliability.iter() {
                        ...
                        self.prop_vars.get(*c_id)
                    {
                        match fw_state.get_route(*r, *p) {
                            ...
                            // Err(NetworkError::ForwardingLoop(r_id)) => {
                            //     println!("Policies checked unsuccessfully!");
                            //     detected_error = Some(NetworkError::ForwardingLoop(r_id));
                            //     Err(PolicyError::NotReliable {
                            //         router: *r,
                            //         prefix: *p,
                            //         link_a: a,
                            ...
                            //     })
                            // }
                            // Err(NetworkError::ForwardingBlackHole(r_id)) => {
                            //     println!("Policies checked unsuccessfully!");
                            //     detected_error = Some(NetworkError::ForwardingBlackHole(r_id));
                            //     Err(PolicyError::NotReliable {
                            //         router: *r,
                            //         prefix: *p,
                            //         link_a: a,
